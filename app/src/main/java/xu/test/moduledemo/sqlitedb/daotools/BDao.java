 ...
 * DAO for table "B".
*/
public class BDao extends AbstractDao<B, Long> {
    ...
    @Override
    protected final void attachEntity(B entity) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(B entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(B entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T1", daoSession.getUniqueDao().getAllColumns());
            builder.append(" FROM B T");
            builder.append(" LEFT JOIN CUSTOMER T0 ON T.\"UNIQUE_ID\"=T0.\"_id\"");
            builder.append(" LEFT JOIN UNIQUE T1 ON T.\"UNIQUE_ID\"=T1.\"_id\"");
            builder.append(' ');
    ...
    protected B loadCurrentDeep(Cursor cursor, boolean lock) {
        B entity = loadCurrent(cursor, 0, lock);
    ...
    public List<B> loadAllDeepFromCursor(Cursor cursor) {
        ...
        List<B> list = new ArrayList<B>(count);
    ...
    public List<B> queryDeep(String where, String... selectionArg) {
