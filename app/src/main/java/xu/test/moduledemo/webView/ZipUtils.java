...
public class ZipUtils {
     ...
     * @return
     */
    public static String findIndexDir(String targetDir){

        File mainDir = new File(targetDir);
        if(mainDir.exists()&&mainDir.isDirectory()){
            for(File file:mainDir.listFiles()){
                String chileResult = findIndexDir(file.getAbsolutePath());
                if(chileResult != null){
                    return chileResult;
                }
            }
        }else if(mainDir.exists() && mainDir.isFile() && mainDir.getName().equals("index.html")){
            return mainDir.getAbsolutePath();
        }
        return null;
    }
