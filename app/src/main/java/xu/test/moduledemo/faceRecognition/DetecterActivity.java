...
public class DetecterActivity extends Activity implements OnCameraListener, View.OnTouchListener, Camera.AutoFocusCallback {
	...
	class FRAbsLoop extends AbsLoop {
		...
		List<FaceDB.FaceRegist> mResgist = new ArrayList<>();
		...
		public void loop() {
			if (mImageNV21 != null) {
				...
				Log.i("matttttt","mImageNV21大小：" + mImageNV21 + ";mWidth=" + mWidth + ";mHeight = " + mHeight);
	...
	public Object onPreview(byte[] data, int width, int height, int format, long timestamp) {
		Log.i("mattttt","视频源数据大小：" + data.length+ ";width = " + width + ";height = " + height);
